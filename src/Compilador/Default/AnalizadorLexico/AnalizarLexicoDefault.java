        ...
        while (true) {
            ...
            if(token!=null){
                ...
                switch (token) {
                    case ERROR:
                        resultadoDelAnalisis.put("status",false);
                        tmp = "Error en el análisis léxico. Símbolo no reconocido: '" + analisisLexico.yytext() + "' Línea: " + numeroDeLinea ;
            ...
            if (token == null) {
                ...
                resultadoDelAnalisis.put("message","Análisis Lexico analizado con éxito. ");
                resultadoDelAnalisis.put("tokens",lecturaTokens);
                return;
            }
        }
